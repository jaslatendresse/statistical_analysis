...
rf = RandomForestClassifier(random_state=RSEED, n_estimators=600, min_samples_split=5, min_samples_leaf=1, max_features='auto', max_depth=80, bootstrap=True)
...
def rf_accuracy():
    print(f'RF - Model Accuracy: {rf.score(X_train, y_train)}')
...
plt.savefig('figures/random_forest_roc_auc_curve.png')

print('\n')

print('Random Forest Confusion Matrix')
cm = confusion_matrix(y_test, rf_predictions)
plot_confusion_matrix(cm, classes = ['Not buggy', 'Buggy'], title = 'Random Forest Model - Buggy File Confusion Matrix')
plt.savefig('figures/random_forest_cm.png')
